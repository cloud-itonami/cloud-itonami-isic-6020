# Operator Quickstart — Community Television Broadcasting Operations

Shortest path from clone to a verified local dry-run for **ISIC 6020** (`cloud-itonami-isic-6020`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6020.git
cd cloud-itonami-isic-6020
```
...
- Blueprint governor key: `broadcast-license-governor`
- Likely source path: `src/**/broadcast-license-governor.cljc`
